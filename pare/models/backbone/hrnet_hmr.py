...
def get_cfg_defaults(pretrained, width=32):
...
def hrnet_w32(pretrained=True, pretrained_ckpt='data/pretrained_models/pose_coco/pose_hrnet_w32_256x192.pth'):
    cfg = get_cfg_defaults(pretrained_ckpt, width=32)
    return get_pose_net(cfg, is_train=True)


def hrnet_w48(pretrained=True, pretrained_ckpt='data/pretrained_models/pose_coco/pose_hrnet_w48_256x192.pth'):
