...
class BaseDataset(Dataset):
    ...
    def __init__(self, options, dataset, ignore_3d=False,
        ...
        if dataset in ['agora-cam-v2', 'coco-cam-camreg', 'coco-campose-camreg'] and is_train:
        ...
        if not self.is_train or (self.is_train and dataset == '3dpw') or self.options.NONPARAMETRIC:
